...
parser.add_argument('--img_dir', default='./via-trafficsign/images/train', help='Training images directory')
parser.add_argument('--label_dir', default='./via-trafficsign/labels/train', help='Training labels directory')
